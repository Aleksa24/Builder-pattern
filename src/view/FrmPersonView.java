...
public class FrmPersonView extends javax.swing.JPanel {
     ...
     */
    public FrmPersonView(PersonViewFactory valueBuilder) {
        initComponents();
        prepareView(valueBuilder);
    }
    ...
    private void prepareView(PersonViewFactory valueBuilder) {
        // PersonViewFactory factory=new SimplePersonViewFactory();
        PersonViewFactory builder = valueBuilder; 
        konstruisi(builder);
        
        panelPerson.add(builder.getPanelPerson());
    }

    private void konstruisi(PersonViewFactory builder) {
        builder.buildFirstNamePanel();
        builder.buildLastNamePanel();
        builder.buildDatePanel();
        builder.buildGenderPanel();
        builder.buildPersonPanel();
    }
}
